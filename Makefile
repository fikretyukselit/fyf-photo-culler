...
ifndef V
	...
	@sed -i.bak 's/^version = "[^"]*"/version = "$(V)"/' pyproject.toml
	...
	@rm -f ui/src-tauri/tauri.conf.json.bak ui/package.json.bak ui/src-tauri/Cargo.toml.bak pyproject.toml.bak README.md.bak
	@echo "Updated:"
